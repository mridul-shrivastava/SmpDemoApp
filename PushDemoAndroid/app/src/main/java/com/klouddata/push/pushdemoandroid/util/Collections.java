...
public class Collections {
	...
	public static final String TRAVEL_AGENCY_COLLECTION = "TravelAgencies";//TravelAgencies_DQ
	public static final String TRAVEL_AGENCY_ENTITY_TYPE = "RMTSAMPLEFLIGHT.Travelagency";
