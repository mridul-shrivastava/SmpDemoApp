...
import com.klouddata.push.pushdemoandroid.activity.MainActivity;
...
public class OnlineManager {
    ...
    public static List<Agency> getAgencies() throws OnlineODataStoreException {
        ...
        if (store != null) {
            ...
            try {
                ...
                MainActivity.setEntities(entities);
     ...
     */
    private static ODataEntity createAgencyEntity(OnlineODataStore store, Agency agency) throws ODataException {
        //BEGIN
